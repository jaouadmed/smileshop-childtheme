...
{if $main_heading['main_image_status']}
    ...
    {$col = 'col-xl-10 col-lg-9 col-md-9 col-sm-8 col-xs-12'}
                ...
                <div class="tvall-product-branner col-xl-2 col-lg-3 col-md-3 col-sm-4">
                	...
                	<div class="tvall-block-box-shadows">
                        ...
                        <div class="tvbanner-hover-wrapper">
                            ...
                            <img src="{$dis_arr_result.path}{$main_heading.data.image}" alt="{l s='Tab Product' mod='tvcmstabproducts'}">
                                    ...
                                    <div class="tvtab-title">
                                        ...
                                        <ul class="tvtabs-products" style="display: flex;align-items: center;">
                                            ...
                                            {foreach $dis_arr_result.data as $data}
                                                ...
                                                <li class="tvtab-name tab-index {if $tmp}active{/if} col-xs-3" data-tab-data='{$data.tab_name_id}' data-tab-paging='{$data.tab_name_class_pagination}' data-tab-data-slider-class='{$data.tab_name_class_slider}'><span>{$data.tab_name}</span></li>
