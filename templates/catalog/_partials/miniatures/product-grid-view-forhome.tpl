    ...
    <div class="tvproduct-wrapper {$class_name}">
        ...
        <div class="tvproduct-image">
            ...
            <a href="{$product.url}" class="thumbnail product-thumbnail" itemprop="url">
                <img data-src="{$product.cover.bySize[$image_size]['url']}" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" alt="{if !empty($product.cover.legend)}{$product.cover.legend}{else}{$product.name}{/if}" class="tvproduct-defult-img lazy" height="{$product.cover.bySize[$image_size]['height']}" width="{$product.cover.bySize[$image_size]['width']}" itemprop="image">
                {if isset($product.images.0.bySize[$image_size]['url']) && empty($product.images.0.cover)}
                <img class="tvproduct-hover-img lazy" data-src="{$product.images.0.bySize[$image_size]['url']}" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" alt="{$product.name}" height="{$product.images.0.bySize[$image_size]['height']}" width="{$product.images.0.bySize[$image_size]['width']}" itemprop="image">
                {elseif isset($product.images.1.bySize[$image_size]['url']) && empty($product.images.1.cover)}
                <img class="tvproduct-hover-img lazy" data-src="{$product.images.1.bySize[$image_size]['url']}" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" alt="{$product.name}" height="{$product.images.1.bySize[$image_size]['height']}" width="{$product.images.1.bySize[$image_size]['width']}" itemprop="image">
                {/if}
            </a>
            {else}
